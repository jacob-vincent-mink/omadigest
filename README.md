...
- **Research watches** — keep a question warm on an hourly, daily, or weekly cadence; choose focused, broad, or deep web research plus a change window, then receive a compact cited brief only when current evidence supports a meaningful change.
